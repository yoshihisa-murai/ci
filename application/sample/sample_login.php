...
$params['meta'] = array(
			...
			'receiver_url' => 'http://xxx.xxx.xxx.xxx/sample_receiver.php' // Point your domain or IP here then the path to the receiver php file file
			);
...
$api->transfer_money_then_redirect($transfer_amount, $transfer_method, 'test124');
