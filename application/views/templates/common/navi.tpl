  <!--drawer menu-->
    <nav id="menu">
        <ul id="menu-menu-2" class=""><li id="menu-item-10" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home"><a href="{'/'|base_url}"><div class="menu_title">ホーム</div><div class="menu_description"></div></a></li>
            ...
            <li id="menu-item-15" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#"><div class="menu_title">プレイデータ</div><div class="menu_description"></div></a></li>
            <li id="menu-item-15" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="{'/'|base_url}payment/history"><div class="menu_title">ユーザーデータ</div><div class="menu_description"></div></a></li>
