                            ...
                            <article class="post-21 post type-post status-publish format-standard has-post-thumbnail hentry category-3">
                                <div class="entry share">
                                    <div class="entry-inner clearfix">
                                        <h2 class="neteller_h2">NETELLER（ネッテラー）マニュアル一覧</h2>
                                        <ul class="link_a">
                                            <li><a href="{'/'|base_url}neteller/regist/">NETELLER口座開設</a></li>
                                            <li><a href="{'/'|base_url}neteller/authority/">NETELLER本人確認の方法</a></li>
                                            <li><a href="{'/'|base_url}neteller/payment/">NETELLER入金方法</a></li>
                                            <li><a href="{'/'|base_url}neteller/payoutatm/">NETELLER出金(ATM)方法</a></li>
                                            <li><a href="{'/'|base_url}neteller/payout/">NETELLER出金方法</a></li>
                                        </ul>
                                    </div>
                                    <!--
