								...
								<div class="entry share">
									...
									<div class="entry-inner clearfix">
										...
										<div class="mypage_menu cf">
											...
											<div class="mypage_menu_btn_box"><a href="{'/'|base_url}withdrawal/"><img src="{'/'|base_url}images/payment_btn.png"></a></div>
											<div class="mypage_menu_btn_box"><img src="{'/'|base_url}images/toto_btn.png"></div>
											<div class="mypage_menu_btn_box"><img src="{'/'|base_url}images/userdata_btn.png"></div>
